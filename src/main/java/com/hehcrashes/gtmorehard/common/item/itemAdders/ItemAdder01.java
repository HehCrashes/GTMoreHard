...
import static com.hehcrashes.gtmorehard.common.GTCMCreativeTabs.tabMetaItem01;
...
public class ItemAdder01 extends ItemAdder_Basic {
    ...
    public static final Item MetaItem01 = new ItemAdder01("MetaItem01Base", "MetaItem01", tabMetaItem01)
        .setTextureName("gtmorehard:MetaItem01/0");
    ...
    public void registerIcons(IIconRegister iconRegister) {
        ...
        this.itemIcon = iconRegister.registerIcon("gtmorehard:MetaItem01/0");
        for (int meta : MetaItem01Map.keySet()) {
            ItemStaticDataClientOnly.iconsMap01.put(meta, iconRegister.registerIcon("gtmorehard:MetaItem01/" + meta));
        }
    }
