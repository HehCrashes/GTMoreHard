package com.hehcrashes.gtmorehard.common.item;

import com.hehcrashes.gtmorehard.GregTechMoreHard;
import com.hehcrashes.gtmorehard.common.api.IHasTooltips;
import com.hehcrashes.gtmorehard.common.api.IHasVariantAndTooltips;
import com.hehcrashes.gtmorehard.utils.TstUtils;
...
public abstract class AbstractTstMetaItem extends Item implements IHasVariantAndTooltips {
    ...
    public void registerIcons(IIconRegister register) {
        this.iconMap = registerAllVariantIcons(
            register,
            meta -> GregTechMoreHard.RESOURCE_ROOT_ID + ":" + unlocalizedName + "/" + meta);
