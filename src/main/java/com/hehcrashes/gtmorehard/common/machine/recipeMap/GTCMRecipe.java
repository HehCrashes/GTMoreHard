package com.hehcrashes.gtmorehard.common.machine.recipeMap;
...
public class GTCMRecipe {
    ...
    public static class GTCMRecipeMap extends GT_Recipe.GT_Recipe_Map {
         ...
         */
        public GTCMRecipeMap(Collection<GT_Recipe> aRecipeList, String aUnlocalizedName, String aLocalName,
